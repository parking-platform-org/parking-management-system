...
public class SQLiteVehicleRepository implements VehicleRepository {
    ...
    /* ------------ DataSource-based constructor required by web UI ------------ */
    ...
    /* ------------ Additional methods exposed for the web UI ------------ */
    ...
    public void addVehicle(Vehicle vehicle) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            ps.setString(8, vehicle.getCreatedAt() != null ? vehicle.getCreatedAt() : String.valueOf(System.currentTimeMillis()));
            ps.executeUpdate();
        } catch (SQLException e) {
            if (e.getMessage().contains("UNIQUE")) {
                throw new IllegalStateException("Vehicle already exists (duplicate plate)", e);
            }
